...
var multi_step_value_1 = require("../../../util/multi-step-value");
var dom_helper_1 = require("../../../util/dom-helper");
...
var DialerComponent = /** @class */ (function () {
    ...
    DialerComponent.prototype.ngAfterViewInit = function () {
        ...
        this.multiStepVal = new multi_step_value_1.MultiStepValue(0, rect.height, this.dialerParams.dialerOptions.length, false, true);
    };
    ...
    DialerComponent.prototype.onKeyDown = function (event) {
        ...
        dom_helper_1.DomHelper.setTransform(this.scrollCont.nativeElement, 0, -this.multiStepVal.currentValue, 0);
    ...
    DialerComponent.prototype.onPanAnimate = function (value) {
        ...
        this.ngZone.run(function () {
            dom_helper_1.DomHelper.setTransform(_this.scrollCont.nativeElement, 0, -value, 0);
        });
    };
    DialerComponent.prototype.onPanEnd = function (event) {
        ...
        this.ngZone.runOutsideAngular(function () {
            ...
            if (latestIndex >= currentIndex) {
                for (var i = currentIndex; i <= latestIndex; i = i + 0.25) {
                    dom_helper_1.DomHelper.setTransform(_this.scrollCont.nativeElement, 0, -rect.height * i, 0);
                }
            }
            else {
        ...
        this.ngZone.run(function () {
            dom_helper_1.DomHelper.setTransform(_this.scrollCont.nativeElement, 0, -_this.multiStepVal.currentValue, 0);
    ...
    DialerComponent = __decorate([
        ...
        __metadata("design:paramtypes", [rc_browser_1.RunContextBrowser, typeof (_e = typeof core_1.Renderer2 !== "undefined" && core_1.Renderer2) === "function" ? _e : Object, typeof (_f = typeof core_1.NgZone !== "undefined" && core_1.NgZone) === "function" ? _f : Object])
    ], DialerComponent);
